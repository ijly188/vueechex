    ...
    <div class="dashboard">
        <div>
            <div class="animated fadeIn">
                <div class="animated fadeIn">
                    <div class="card">
                        <div class="card-header">ashboard</div>
                        <div class="card-body">
                            <div class="list-group list-group-accent">
                                <br><strong>api許願：dashboard只是展示用哦</strong>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-sm-6 col-lg-3">
                        ...
                        <div class="chart-wrapper mt-3 mx-3" style="height:70px;">
                            ...
                            visibility: hidden; z-index: -1;">
                                ...
                                bottom:0;overflow:hidden;pointer-events:none;
                                visibility:hidden;z-index:-1;">
                                    <div
                            ...
                            <canvas class="chart chartjs-render-monitor"
                            id="card-chart1" height="140" width="282"
                            style="display: block; height: 70px; width: 141px;"></canvas>
                        </div>
                        </div>
                    </div>
                    <div class="col-sm-6 col-lg-3">
                        ...
                        <div class="chart-wrapper mt-3 mx-3" style="height:70px;">
                            ...
                            <canvas class="chart chartjs-render-monitor"
                            id="card-chart2" height="140" width="282"
                            style="display: block; height: 70px; width: 141px;"></canvas>
                            <div id="card-chart2-tooltip" class="chartjs-tooltip bottom"
                            style="opacity: 0; left: 22.538px; top: 138.372px;">
                                <div class="tooltip-header">
                                    <div class="tooltip-header-item">January</div>
                                </div>
                                <div class="tooltip-body">
                                    <div class="tooltip-body-item">
                                        <span class="tooltip-body-item-color"
                                        style="background-color: rgb(38, 203, 253);"></span>
                                        <span class="tooltip-body-item-label">
                                            My First dataset
                                        </span>
                                        <span class="tooltip-body-item-value">1</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-sm-6 col-lg-3">
                        ...
                        <div class="chart-wrapper mt-3" style="height:70px;">
                            ...
                            <canvas class="chart chartjs-render-monitor"
                            id="card-chart3" height="140" width="346"
                            style="display: block; height: 70px; width: 173px;"></canvas>
                            <div id="card-chart3-tooltip" class="chartjs-tooltip top"
                            style="opacity: 0; left: 87px; top: 126.5px;">
                                <div class="tooltip-header">
                                ...
                                <div class="tooltip-body">
                                    <div class="tooltip-body-item">
                                        <span class="tooltip-body-item-color"
                                        style="background-color: rgba(230, 230, 230, 0.2);"></span>
                                        <span class="tooltip-body-item-label">
                                            My First dataset
                                        </span>
                                        <span class="tooltip-body-item-value">45</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-sm-6 col-lg-3">
                        ...
                        <div class="chart-wrapper mt-3 mx-3" style="height:70px;">
                            ...
                            <canvas class="chart chartjs-render-monitor"
                            id="card-chart4" height="140" width="282"
                            style="display: block; height: 70px; width: 141px;"></canvas>
                            <div id="card-chart4-tooltip" class="chartjs-tooltip top"
                            style="opacity: 0; left: 38px; top: 102px;">
                                <div class="tooltip-header">
                                ...
                                <div class="tooltip-body">
                                    <div class="tooltip-body-item">
                                        ...
                                        <span class="tooltip-body-item-value">80</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <canvas class="chart chartjs-render-monitor"
                        id="main-chart" height="600" width="1496"
                        style="display: block; height: 300px; width: 748px;"></canvas>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6 col-lg-3">
                        ...
                        <div class="brand-card-header bg-facebook">
                            ...
                            <div class="chart-wrapper">
                                ...
                                <canvas id="social-box-chart-1" height="192"
                                width="346" class="chartjs-render-monitor"
                                style="display: block; height: 96px; width: 173px;"></canvas>
                            </div>
                        </div>
                    ...
                    <div class="col-sm-6 col-lg-3">
                        ...
                        <div class="brand-card-header bg-twitter">
                            ...
                            <div class="chart-wrapper">
                                ...
                                <canvas id="social-box-chart-2" height="192"
                                width="346" class="chartjs-render-monitor"
                                style="display: block; height: 96px; width: 173px;"></canvas>
                            </div>
                        </div>
                    ...
                    <div class="col-sm-6 col-lg-3">
                        ...
                        <div class="brand-card-header bg-linkedin">
                            ...
                            <div class="chart-wrapper">
                                ...
                                <canvas id="social-box-chart-3" height="192"
                                width="346" class="chartjs-render-monitor"
                                style="display: block; height: 96px; width: 173px;"></canvas>
                            </div>
                        </div>
                    ...
                    <div class="col-sm-6 col-lg-3">
                        ...
                        <div class="brand-card-header bg-google-plus">
                            ...
                            <div class="chart-wrapper">
                                ...
                                <canvas id="social-box-chart-4" height="192"
                                width="346" class="chartjs-render-monitor"
                                style="display: block; height: 96px; width: 173px;"></canvas>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    ...
                                    <div class="progress-group-bars">
                                        ...
                                        <div class="progress progress-xs">
                                            <div class="progress-bar bg-danger"
                                            role="progressbar" style="width: 91%"
                                    ...
                                    <div class="progress-group-bars">
                                        <div class="progress progress-xs">
                                            ...
                                            ria-valuenow="9" aria-valuemin="0" a
                                            ia-valuemax="100"></div>
                                        </div>
                                        <div class="progress progress-xs">
                                            <div class="progress-bar bg-danger"
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="progress-group-bars">
                                        <div class="progress progress-xs">
                                            ...
                                            ria-valuenow="8" aria-valuemin="0" a
                                            ia-valuemax="100"></div>
                                        </div>
                                    </div>
                                    </div>
                                ...
                                <tbody>
                                    ...
                                    <td class="text-center">
                                        <div class="avatar">
                                            ...
                                            src="https://coreui.io/demo/img/avatars/1.jpg"
                                    ...
                                    <td class="text-center">
                                        <i class="flag-icon flag-icon-us h4 mb-0"
                                        id="us" title="us"></i>
                                    </td>
                                    <td>
                                        <div class="clearfix">
                                    ...
                                    <td class="text-center">
                                        <div class="avatar">
                                            <img class="img-avatar"
                                            src="https://coreui.io/demo/img/avatars/2.jpg"
                                            alt="admin@bootstrapmaster.com">
                                    ...
                                    <td class="text-center">
                                        <i class="flag-icon flag-icon-br h4 mb-0"
                                        id="br" title="br"></i>
                                    </td>
                                    <td>
                                        <div class="clearfix">
                                    ...
                                    <td class="text-center">
                                        <div class="avatar">
                                            <img class="img-avatar"
                                            src="https://coreui.io/demo/img/avatars/3.jpg"
                                            alt="admin@bootstrapmaster.com">
                                    ...
                                    <td class="text-center">
                                        <i class="flag-icon flag-icon-in h4 mb-0"
                                        id="in" title="in"></i>
                                    </td>
                                    <td>
                                        <div class="clearfix">
                                    ...
                                    <td class="text-center">
                                        <div class="avatar">
                                            <img class="img-avatar"
                                            src="https://coreui.io/demo/img/avatars/4.jpg"
                                            alt="admin@bootstrapmaster.com">
                                    ...
                                    <td class="text-center">
                                        <i class="flag-icon flag-icon-fr h4 mb-0"
                                        id="fr" title="fr"></i>
                                    </td>
                                    <td>
                                        <div class="clearfix">
                                    ...
                                    <td class="text-center">
                                        <div class="avatar">
                                            <img class="img-avatar"
                                            src="https://coreui.io/demo/img/avatars/5.jpg"
                                            alt="admin@bootstrapmaster.com">
                                            <span class="avatar-status badge-success"></span>
                                        </div>
                                    </td>
                                    ...
                                    <td class="text-center">
                                        <i class="flag-icon flag-icon-es h4 mb-0"
                                        id="es" title="es"></i>
                                    </td>
                                    <td>
                                        <div class="clearfix">
                                    ...
                                    <td class="text-center">
                                        <div class="avatar">
                                            <img class="img-avatar"
                                            src="https://coreui.io/demo/img/avatars/6.jpg"
                                            alt="admin@bootstrapmaster.com">
                                            <span class="avatar-status badge-danger"></span>
                                        </div>
                                    </td>
                                    ...
                                    <td class="text-center">
                                        <i class="flag-icon flag-icon-pl h4 mb-0"
                                        id="pl" title="pl"></i>
                                    </td>
                                    <td>
                                        <div class="clearfix">
