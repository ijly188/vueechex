        ...
        <div class="my-5 row justify-content-left">
            <form class="col-12" @submit.prevent="createOrder">
                <div class="form-group">
                    ...
                    >*Email</label>
                    <input type="email"
                    class="form-control sizefull s-text7 p-l-15 p-r-15 bo4"
                ...
                <div class="text-right size14 trans-0-4 m-b-10">
                    <button class="flex-c-m sizefull bg1 bo-rad-23
                    hov1 s-text1 trans-0-4">送出訂單</button>
                </div>
            </form>
        </div>
    </div>
