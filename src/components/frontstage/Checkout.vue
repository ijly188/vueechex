<template>
    <div class="checkout">
        ...
        <section class="cart bgwhite p-t-70 p-b-100">
            <div class="container" v-if="orderId == ''">
                訂單編號錯誤！！請回聯絡客服人員。
            </div>
                    ...
                    <div class="card-body">
                        <div class="my-5 row justify-content-center">
                            <form class="col-md-6" @submit.prevent="payOrder">
                                ...
                                <div class="size15 trans-0-4 text-right"
...
import smallonepicslide from './components/checkout/smallonepicslide';
import '../../../static/frontstage/vendor/select2/select2';
...
export default {
  ...
  created() {
    this.orderId = this.$route.params.checkoutid;
    this.getCheckout();
  },
};
</script>
