<template>
    <header class="app-header navbar">
        ...
        <router-link to="/backstage" class="navbar-brand">
        ...
        <li class="nav-item px-3">
            <router-link to="/backstage" class="nav-link">儀表板</router-link>
        </li>
        <li class="nav-item px-3">
            <router-link to="/backstage/user" class="nav-link">使用者</router-link>
        </li>
        <li class="nav-item px-3">
            <router-link to="/backstage/settings" class="nav-link">系統設定</router-link>
        </li>
        </ul>
                ...
                <a class="dropdown-item" href="#">
                    ...
                    <div class="py-3 mr-3 float-left">
                        <div class="avatar">
                            ...
                            src="https://coreui.io/demo/img/avatars/7.jpg"
        ...
        <li class="nav-item dropdown">
            <router-link class="nav-link nav-link"
        ...
        d-md-down-none" type="button"
        data-toggle="aside-menu-lg-show">
            <span class="navbar-toggler-icon"></span>
        </button>
        <button class="navbar-toggler aside-menu-toggler
        d-lg-none" type="button"
